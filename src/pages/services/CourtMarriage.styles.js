...
export const CourtMarriageContainer = styled.div`
    ...
    .cm-section{padding:60px 24px}
    .cm-container{max-width:1280px;margin:0 auto;display:grid;grid-template-columns:1fr 380px;gap:36px;align-items:start}
    .cm-main{background:#fff;padding:48px;border-radius:20px;box-shadow:0 16px 48px rgba(28,41,81,0.08);border:1px solid rgba(28,41,81,0.06)}
    .cm-main h1{font-size:clamp(2rem,3.5vw,3rem);margin-bottom:8px}
    .cm-byline{color:var(--text-secondary);margin-bottom:18px}
    ...
    .cm-sidebar{position:sticky;top:22px}
